...
for(s in c(3,4,5) ){
  ...
  output <- paste("Bei einer Standabweichung von",s, "bestehen",ausgezeichnet*100,"% ausgezeichnet.")
  print(output)
}
...
Die Anzahl der guten Noten ist im Verhältnis zur Anzahl der schlechten Noten ziemlich klein; es gibt viel mehr schlechte Noten als gute.

Warum?

Es werden mehr schlechte Noten betrachtet als gute.
...
Die kritischen Werte für einen zweiseitigen $z$-Test sind $\pm$ (bei Aplha=0,06) $\pm$ `r qnorm(0.97)` (bei Alpha=0,05) $\pm$ `r qnorm(0.975)`.
